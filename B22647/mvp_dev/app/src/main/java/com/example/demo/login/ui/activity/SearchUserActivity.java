...
public class SearchUserActivity extends BaseActivity{
    ...
    private void loadComment(String querry) {
        ...
        if (querry != null) bmobQuery.addWhereEqualTo("username", querry);
        ...
        bmobQuery.findObjects(new FindListener<UserData>() {
            ...
            public void done(List<UserData> list, BmobException e) {
                if (e == null) {
                    ...
                    for (UserData room : list) {
                        mHashMap = new HashMap<>();
                        Log.e(Debug.filename(new Exception()), Debug.funAndLine(new Exception()) + room.getObjectId());
                        mHashMap.put("name", room.getUsername());
                        mHashMap.put("email", room.getUserEmail());
                        mHashMap.put("phone", room.getUserPhone());
