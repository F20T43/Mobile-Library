...
private static boolean askForPremission=true;
...
/*
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && askForPremission) {
            askForPremission =false;
            for (String str : permissions) {
                // 检查该权限是否已经获取
                int i = this.checkSelfPermission(str);
