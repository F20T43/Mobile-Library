...
import static com.stl.mobilelibrary.ViewBookActivity.ISBN;
...
public class DatabaseHelper {
     ...
     */
    public void createAccountIfValid(final String userName, final String password, final String emailAddress, final String phoneNumber, final ViewableImage image){
        databaseReference.child("Users").orderByChild("userName").equalTo(userName)
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    createAccount(userName, password, emailAddress, phoneNumber, image);
                }
            }
     ...
     * @param image: the user's profile picture
     */
    private void createAccount(final String userName, String password, final String emailAddress, final String phoneNumber, final ViewableImage image){
                ...
                .addOnCompleteListener((Activity) context, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            accountCreated(new User(userName, firebaseUser.getUid(), new ContactInfo(emailAddress, phoneNumber, null), image));
                        }
                        else {
