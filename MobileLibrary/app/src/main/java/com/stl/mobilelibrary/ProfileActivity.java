...
/**
 * Displays a user's profile, can display either the current user's profile or the profile of another user
 */
    ...
    private void updateContactInfoFields(){
        ...
        if (currentImage == null) {
            ViewableImage defaultImage = new ViewableImage(
                    BitmapFactory.decodeResource(getResources(), R.drawable.ic_baseline_perm_identity_24)
            );
